  ...
  return (
    <Section className="flex flex-col justify-end bg-black">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to- from-black via-black/50 to-transparent" />
      </div>
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-12 pb-12 flex flex-col items-center">
        ...
        >
          ...
          <p className="text-zinc-400 text-lg md:text-xl max-w-2xl mx-auto font-medium leading-relaxed">
            Empowering brands through innovative design and strategic
            excellence. We are the world leader in digital rehabilitation and
            creative growth.
          </p>
        </motion.div>
        ...
        <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-end border-b border-zinc-800 pb-12 mb-8">
          ...
          <div className="space-y-8">
            ...
            <p className="text-zinc-500 text-sm max-w-md leading-relaxed">
              A strategic partnership between Creative Branding Studio and
              leading global enterprises. Delivering excellence since 2024.
            </p>
          </div>
