...
export const FAQSection = () => {
  ...
  return (
    <Section id="faq" className="bg-black flex flex-col justify-between relative overflow-hidden min-h-screen lg:h-screen w-full snap-start select-none py-12 lg:py-6">
